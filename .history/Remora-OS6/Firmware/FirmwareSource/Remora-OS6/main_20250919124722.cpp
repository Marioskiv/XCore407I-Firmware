...
#include "remora.h"
#if defined(TARGET_XCORE407I)
#include "TARGET_XCORE407I/ethernet_init.h"
#include "TARGET_XCORE407I/lwip/lwip_port.h"
#include "TARGET_XCORE407I/lwip/remora_udp.h"
#endif
...
{
    #if defined(TARGET_XCORE407I)
    /* Bring up Ethernet early (after SystemInit/HAL_Init done before main) */
    MX_ETH_Init();
        lwip_port_init();
        remora_udp_init();
        stepgen_init();
