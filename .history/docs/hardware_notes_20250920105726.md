...
| RESET   | PG13      | Out | Active low (≥10–50 ms low) |
...
2. PHY Strap Sampling: Occurs immediately after RESET release. Keep RMII data pins as GPIO (not AF) until after ≥5–10 ms from reset deassert so strap resistors are correctly latched.
...
---
Document version: 1.0 (Generated for firmware diagnostic & development support)
